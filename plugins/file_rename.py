...
def handle_file_rename_request(files):
    print(f"Received {len(files)} files for renaming.")
    add_files_to_queue(files)

# Example usage
if __name__ == "__main__":
    files = [f"file_{i}" for i in range(20)]  # Example files
    handle_file_rename_request(files)
